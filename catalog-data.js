(() => {
  ...
  const products = {
    "taupe-baguette": {
      ...
      name: "TAUPE BAGUETTE",
      category: "new",
      categoryLabel: categories.new.label,
      categoryTitle: categories.new.title,
      badge: "НОВИНКА",
      unitPrice: 70,
    ...
    "choco-shopper": {
      ...
      url: createProductUrl("choco-shopper"),
      subtitle: "Шоколадная замшевая сумка-тоут для офиса, города и повседневных образов.",
      description:
        "Шоколадная сумка-тоут из мягкой искусственной замши с золотистой фурнитурой и вместительным форматом.",
      descriptionHtml:
    ...
    "anagram-straw-tote": {
      ...
      url: createProductUrl("anagram-straw-tote"),
